...
// ═══════════════════════════════════════════════════════════════════
// Single codebase: Home, Education Intelligence (landing→survey→
// results→PDF), Business Intelligence (survey→results→lead capture),
// Interactive Horizon Map, About. Zero backend. Fully deployable.
// ═══════════════════════════════════════════════════════════════════
...
const MATURITY=[
  ...
  {level:3,label:"Exploring",floor:41,ceiling:60,color:C.amber,desc:"Active experimentation in pockets. Some departments show good practice, but adoption is uneven and not yet systematic."},
  {level:4,label:"Embedding",floor:61,ceiling:80,color:C.blue,desc:"AI is integrated into strategy, operations, and curriculum. Systematic CPD and governance frameworks are in place."},
  {level:5,label:"Transforming",floor:81,ceiling:100,color:C.teal,desc:"AI is deeply embedded and continuously evolving. The institution leads sector innovation."},
];

// ═══════════════════════════════════════════════════════════════════
// EDUCATION INTELLIGENCE — Survey Config
// ═══════════════════════════════════════════════════════════════════
const EDU_SECTIONS=[
  {id:"strategic_direction",name:"Strategic Direction",weight:.12,icon:"◆",desc:"Leadership vision, AI strategy, board engagement.",questions:[
    {id:"sd1",text:"Does the college have an AI-specific strategic roadmap approved by the Governing Body?",options:[{label:"Yes, fully operational and funded",score:4},{label:"In development / partially operational",score:3},{label:"AI mentioned in wider Digital Strategy only",score:2},{label:"No AI strategy exists",score:1}]},
    {id:"sd2",text:"Which best describes the college's current approach to AI policy?",options:[{label:"Integrated across all academic, IT, and data policies",score:4},{label:"Standalone AI Use Policy",score:3},{label:"Interim guidance, no formal policy",score:2},{label:"Policies focus on prohibition and detection",score:1}]},
    {id:"sd3",text:"How often is the Governing Body updated on AI implementation?",options:[{label:"Monthly / every board meeting",score:4},{label:"Termly",score:3},{label:"Annually",score:2},{label:"Rarely or not at all",score:1}]}
  ]},
  {id:"teaching_learning",name:"Teaching & Assessment",weight:.13,icon:"▣",desc:"AI tools in curriculum, assessment design, detection stance.",questions:[
    {id:"tl1",text:"What percentage of qualifications have undergone a formal AI-proofing review?",options:[{label:">75%",score:4},{label:"50–75%",score:3},{label:"25–49%",score:2},{label:"<25%",score:1}]},
    {id:"tl2",text:"Do students have access to a college-provided enterprise-grade AI assistant?",options:[{label:"Yes, universal access",score:4},{label:"Yes, specific courses only",score:3},{label:"Directed to free public versions",score:2},{label:"AI tools restricted on network",score:1}]},
    {id:"tl3",text:"How integrated is AI into vocational and technical training?",options:[{label:"Widespread across multiple areas",score:4},{label:"Selective — one or two departments",score:3},{label:"Exploring / piloting",score:2},{label:"Not used",score:1}]},
    {id:"tl4",text:"What is your stance on AI detection software?",options:[{label:"Phased out — redesigned AI-resistant assessments instead",score:4},{label:"One indicator in a broader human-led review",score:3},{label:"Used extensively as primary gatekeeper",score:2},{label:"Do not use detection tools",score:1}]}
  ]},
  {id:"pedagogical_transformation",name:"Pedagogical Transformation",weight:.25,icon:"◉",desc:"The deepest measure — is the purpose and method of teaching evolving?",questions:[
    {id:"pt1",text:"Which best describes your approach to the PURPOSE of teaching in an AI-enabled world?",options:[{label:"Fundamentally reviewed what we teach and why — refocused on human capabilities",score:4},{label:"Begun this review in some departments, not yet college-wide",score:3},{label:"Adjusted assessments and added AI awareness, core approach unchanged",score:2},{label:"Not yet undertaken a fundamental review",score:1}]},
    {id:"pt2",text:"How much of your largest programme's content could current AI perform competently?",options:[{label:"Less than 25%",score:4},{label:"25–50%",score:3},{label:"50–75%",score:2},{label:"More than 75%",score:1},{label:"We have not conducted this analysis",score:0}]},
    {id:"pt3",text:"How does the college approach AI in the PROCESS of learning?",options:[{label:"Students actively taught to use AI as a collaborative thinking tool",score:4},{label:"Permitted with guidelines, not systematically taught",score:3},{label:"Primarily monitored and restricted — focus on detection",score:2},{label:"No clear position yet",score:1}]},
    {id:"pt4",text:"Has the college mapped how AI is changing the occupations each vocational programme trains for?",options:[{label:"Systematic review with employers — training reflects AI-augmented roles",score:4},{label:"Done for some programmes, not all",score:3},{label:"Rely on awarding body updates and employer feedback",score:2},{label:"Not undertaken",score:1}]},
    {id:"pt5",text:"Are students involved in shaping how AI is used in their learning?",options:[{label:"Formal mechanisms — panels, co-design workshops, feedback loops",score:4},{label:"Feedback gathered but students don't directly influence decisions",score:3},{label:"Students informed but not consulted",score:2},{label:"Not yet engaged students",score:1}]},
    {id:"pt6",text:"Has the college considered how robotics and embodied AI may affect the vocational occupations you currently treat as AI-resistant?",options:[{label:"Yes — we are actively preparing students for human-machine orchestration alongside manual skills",score:4},{label:"We are aware of this trajectory but have not yet acted on it",score:3},{label:"We believe the physical trades are safe from AI for the foreseeable future",score:2},{label:"We have not considered this",score:1}]},
    {id:"pt7",text:"Are your trade and vocational programmes training students to deploy, supervise, and audit automated or robotic systems alongside their practical skills?",options:[{label:"Yes — human-machine orchestration is embedded in multiple programmes",score:4},{label:"We have begun introducing collaborative robotics in one or two areas",score:3},{label:"We are exploring this but have no current provision",score:2},{label:"No — our trade programmes focus entirely on manual execution",score:1}]}
  ]},
  {id:"staff_readiness",name:"Staff Readiness",weight:.12,icon:"◈",desc:"Educator confidence, CPD, communities of practice.",questions:[
    {id:"sr1",text:"What percentage of teaching staff received 3+ hours of formal AI training in the last 12 months?",options:[{label:">75%",score:4},{label:"50–75%",score:3},{label:"25–49%",score:2},{label:"<25%",score:1}]},
    {id:"sr2",text:"Does the college utilise an AI Champions network or Community of Practice?",options:[{label:"Yes, highly active and influential",score:4},{label:"Yes, but impact is limited",score:3},{label:"Planning to launch one",score:2},{label:"No",score:1}]},
    {id:"sr3",text:"To what extent are AI tools embedded in staff non-teaching workflows?",options:[{label:"Universal: most staff reclaim 2+ hours/week",score:4},{label:"Moderate: some staff, not standardised",score:3},{label:"Minimal: largely discouraged or rare",score:2},{label:"Not used",score:1}]}
  ]},
  {id:"operations",name:"Operations",weight:.10,icon:"▥",desc:"Data maturity, admissions, retention analytics.",questions:[
    {id:"op1",text:"Is the college using predictive AI for student retention?",options:[{label:"Yes, integrated system triggering interventions",score:4},{label:"Yes, standalone but not fully effective",score:3},{label:"Evaluating systems",score:2},{label:"No",score:1}]},
    {id:"op2",text:"Rate the institution's Data Maturity.",options:[{label:"High: single source of truth, automated reporting",score:4},{label:"Moderate: connected but manual cleaning",score:3},{label:"Low: data siloed",score:2},{label:"Very low: no integration",score:1}]}
  ]},
  {id:"ethics_governance",name:"Ethics & Governance",weight:.08,icon:"◍",desc:"Data protection, bias monitoring, equitable access.",questions:[
    {id:"eg1",text:"Does the college conduct DPIAs before deploying student-facing AI tools?",options:[{label:"Always",score:4},{label:"For major tools only",score:3},{label:"Rarely",score:2},{label:"No formal process",score:1}]},
    {id:"eg2",text:"What measures ensure disadvantaged students have equitable AI access?",options:[{label:"Universal premium access for all",score:4},{label:"Specific bursary or funding",score:3},{label:"Rely on free tools",score:2},{label:"Not yet addressed",score:1}]}
  ]},
  {id:"workforce_alignment",name:"Workforce Alignment",weight:.08,icon:"◇",desc:"Employer engagement, levy use, AI in occupations.",questions:[
    {id:"wa1",text:"How many curriculum areas include AI literacy in employability modules?",options:[{label:"All curriculum areas",score:4},{label:"More than half",score:3},{label:"Only tech-specific subjects",score:2},{label:"None",score:1}]},
    {id:"wa2",text:"How frequently do you consult employers on AI skill requirements?",options:[{label:"Monthly / regular advisory boards",score:4},{label:"Termly",score:3},{label:"Annually",score:2},{label:"Rarely",score:1}]}
  ]},
  {id:"student_experience",name:"Student Experience",weight:.05,icon:"○",desc:"Student voice, AI-enhanced services.",questions:[
    {id:"se1",text:"Have you surveyed students about their AI usage and expectations?",options:[{label:"Yes, formal surveys with action plans",score:4},{label:"Informal feedback",score:3},{label:"Planning to",score:2},{label:"No",score:1}]},
    {id:"se2",text:"Do student-facing services incorporate AI for personalisation?",options:[{label:"Yes, across multiple services",score:4},{label:"In limited areas",score:3},{label:"Exploring",score:2},{label:"No",score:1}]}
  ]},
  {id:"financial_sustainability",name:"Financial Sustainability",weight:.07,icon:"▦",desc:"AI productivity dividend, competitive positioning.",questions:[
    {id:"fs1",text:"Is the AI Productivity Dividend in 3-year financial forecasts?",options:[{label:"Yes, with clear targets",score:4},{label:"Yes, without specific targets",score:3},{label:"Currently viewed as a cost",score:2},{label:"No",score:1}]},
    {id:"fs2",text:"By 2030, what % of curriculum delivery will be AI-augmented?",options:[{label:">75%",score:4},{label:"50–75%",score:3},{label:"25–49%",score:2},{label:"<25%",score:1}]}
  ]},
];

// ─── Scoring ───
function scoreEdu(responses){
  let comp=0,tw=0;const results={};
  for(const sec of EDU_SECTIONS){
    const ans=sec.questions.filter(q=>responses[q.id]!==undefined);
    const raw=ans.reduce((s,q)=>s+(responses[q.id]??0),0);
    const mp=ans.length*4;const norm=mp>0?Math.round((raw/mp)*100):0;
    results[sec.id]={name:sec.name,score:norm,weight:sec.weight,answered:ans.length,total:sec.questions.length};
    comp+=norm*sec.weight;tw+=sec.weight;
  }
  const final=tw>0?Math.round(comp/tw):0;
  const mat=MATURITY.find(m=>final>=m.floor&&final<=m.ceiling)||MATURITY[0];
  return{composite:final,maturity:mat,sections:results};
}
...
// ═══════════════════════════════════════════════════════════════════
// BUSINESS INTELLIGENCE — Survey Config
// ═══════════════════════════════════════════════════════════════════
const BIZ_SECTIONS=[
  {id:"profile",name:"About Your Business",icon:"◆",questions:[
    {id:"b_sector",text:"Which sector best describes your business?",options:["Professional Services","Healthcare and Social Care","Manufacturing and Engineering","Construction and Trades","Retail, Hospitality, and Leisure","Logistics and Distribution","Creative, Media, and Digital","Other"]},
    {id:"b_size",text:"How many employees?",options:["1–10","11–50","51–250","250+"]},
    {id:"b_region",text:"Where is your business based?",options:["West Midlands","East Midlands","North West","North East","Yorkshire","South West","South East","London","Other UK"]}
  ]},
  {id:"awareness",name:"AI Awareness",icon:"◇",questions:[
    {id:"b_aware",text:"How would you describe your understanding of what AI could do for your business?",options:["Clear — we know where AI could add value","General awareness — not sure where to start","Limited — heard about AI but feels distant","Uncertain — not sure if AI is relevant"]},
    {id:"b_used",text:"Is your business currently using any AI tools?",options:["Yes, across multiple areas","Yes, in specific tasks","One or two people experimenting","No, not currently"]},
    {id:"b_barrier",text:"What feels like the biggest barrier?",options:["Not sure where to start","Concerned about cost and ROI","Lack of skills in the team","Worried about data security","Don't believe AI is relevant","Already using — looking for next steps"]}
  ]},
  {id:"operations",name:"Where Could AI Help?",icon:"▣",questions:[
    {id:"b_drain",text:"Which area consumes the most time on repetitive tasks?",options:["Admin, invoicing, paperwork","Customer communication","Scheduling and coordination","Reporting and compliance","Marketing and content","Recruitment and onboarding","Stock management","Not sure — everything is busy"]},
    {id:"b_freeup",text:"If you freed up 5 hours a week, where would it go?",options:["Winning new business","Customer service","Developing the team","Strategic thinking","Personal workload reduction","Not sure"]},
    {id:"b_digital",text:"How confident are your staff with digital tools?",options:["Very confident","Reasonably confident","Mixed","Low confidence"]}
  ]},
  {id:"interest",name:"Your Interest",icon:"◈",questions:[
    {id:"b_want",text:"What would be most useful right now?",options:["A free, detailed AI audit of our business","A short report based on this survey","A conversation in plain language","Just exploring — not ready yet"]},
    {id:"b_when",text:"When are you thinking about exploring AI?",options:["As soon as possible","Next 3–6 months","Sometime this year","No timeline — just interested"]}
  ]},
];
...
// ═══════════════════════════════════════════════════════════════════
const HORIZON=[
  {id:"h1_2026",label:"H1 2026",range:"January to June 2026",conf:"high",tracks:{
    technology:{h:"Multimodal AI Goes Mainstream",d:"Multimodal AI becomes the standard workplace toolkit. Models processing text, image, audio, and video in unified workflows are embedded across most white-collar industries. Enterprise assistants are standard issue. Code generation handles 60-70% of routine tasks. Students graduating without multimodal fluency are already behind."},
    policy:{h:"DfE Leadership Toolkit Rollout",d:"The DfE AI Leadership Toolkit becomes the de facto standard for college strategic planning. Ofsted evaluates digital strategy as part of leadership judgements. Skills England publishes its AI Foundation Skills benchmark. The Growth and Skills Levy becomes operational."},
    labour:{h:"Administrative Compression Begins",d:"Large employers consolidate admin and data entry roles. Legal, accounting, and financial firms accelerate AI adoption. The NHS announces its AI integration roadmap. Business Administration, Legal Services, and AAT programmes need urgent curriculum review."},
    expectations:{h:"The 92% Generation Arrives",d:"Students entering college have used AI throughout school — 92% use AI tools regularly. They expect personalised, AI-enhanced learning. Employers list AI proficiency in job specs for the first time. Colleges restricting rather than teaching AI are out of step."}}},
  {id:"h2_2026",label:"H2 2026",range:"July to December 2026",conf:"high",tracks:{
    technology:{h:"AI Agents Enter the Workplace",d:"Autonomous AI agents handle procurement, customer service, and coordination end-to-end. AI tutoring demonstrates measurable learning gains. Voice-first interfaces become viable for workshops and clinics."},
    policy:{h:"EU AI Act Enforcement",d:"EU AI Act high-risk provisions take effect for education. UK institutions with European partnerships must comply. Ofqual publishes updated guidance moving beyond prohibition. Apprenticeship standards begin AI relevance review."},
    labour:{h:"Healthcare and Construction Adopt AI",d:"NHS deploys ambient clinical documentation. Construction firms adopt AI-driven BIM. Logistics integrates route optimisation. Health, Construction, and Logistics programmes must integrate industry AI tools into training."},
    expectations:{h:"Employers Shift Hiring Criteria",d:"Employers formally assess AI capability in recruitment. AI-augmented productivity enters performance reviews. Parents ask about college AI strategy at open evenings. Colleges need visible AI strategies to maintain market position."}}},
  {id:"h1_2027",label:"H1 2027",range:"January to June 2027",conf:"high",tracks:{
    technology:{h:"AI Becomes Invisible Infrastructure",d:"AI is embedded in every major platform — invisible infrastructure. Personalised AI tutors reach maturity. AI-generated video is indistinguishable from human. Teaching how to use AI matters less than teaching how to think alongside it."},
    policy:{h:"Qualification Reform Accelerates",d:"Skills England completes first apprenticeship reviews for AI. T-Levels begin AI literacy revision. DfE publishes formal FE expectations — guidance becomes expectation. Unreformed qualifications risk non-compliance and declining interest."},
    labour:{h:"Skills Lifespan Below 3 Years",d:"Average technical skill lifespan under three years. Qualifications may be partially obsolete before completion. Employers hire for adaptability over specific skills. Modular, stackable credentials become essential."},
    expectations:{h:"The Benchmarking Moment",d:"League tables incorporate AI readiness. Employer surveys measure graduate AI-readiness. The first AI-taught cohort enters the labour market. AI readiness becomes a competitive differentiator."}}},
  {id:"h2_2027",label:"H2 2027",range:"July to December 2027",conf:"probable",tracks:{
    technology:{h:"Autonomous Agents Mature",d:"Second-gen agents manage workflows and make routine decisions. AI assessment evaluates practical skills through video. Digital twins of workplaces become viable for vocational training. Written-only assessment is increasingly obsolete."},
    policy:{h:"Ofsted AI Inspection Maturity",d:"Inspection teams include digital specialists. Good judgements require evidence of meaningful AI integration. Capital funding linked to digital transformation. AI is an expected baseline, not an innovation bonus."},
    labour:{h:"The First Enrolment Shock",d:"Demographic decline hits FE. Competition from online providers and bootcamps intensifies. AI-enhanced flexible delivery models fare better. Dual pressure: fewer students, higher expectations. AI efficiency becomes survival imperative."},
    expectations:{h:"Lifelong Learning Demand Surges",d:"Adult AI upskilling becomes a major market. Levy drives employer-funded short courses. Micro-credential recognition demanded. Education-work boundary blurs. Colleges serving only 16-18s miss the fastest-growing segment."}}},
  {id:"h1_2028",label:"H1 2028",range:"January to June 2028",conf:"probable",tracks:{
    technology:{h:"AI Reasoning at Professional Level",d:"Expert-level AI reasoning across law, medicine, engineering. The gap between 'help' and 'do' narrows for knowledge work. Robotics enter physical environments. The question: which aspects of every job remain distinctly human?"},
    policy:{h:"National AI Literacy Standard",d:"Formal AI Literacy Standard introduced. FE colleges as primary delivery agents. AI outcomes mandated across all Level 2+ qualifications. AI literacy becomes universal entitlement, not optional."},
    labour:{h:"Role Redesign Across All Sectors",d:"Most industries complete role redesign around AI. Human-AI teaming is standard. New roles established: AI trainers, ethics auditors, workflow designers. Every vocational pathway needs human-AI collaboration as core competence."},
    expectations:{h:"Personalisation Non-Negotiable",d:"Students expect genuinely tailored pathways via adaptive platforms. One-size-fits-all delivery viewed as outdated. Employers expect graduates who learn new AI tools independently. Fixed curricula feel anachronistic."}}},
  {id:"h1_2029",label:"H1 2029",range:"January to June 2029",conf:"probable",tracks:{
    technology:{h:"The AGI Debate",d:"AI approaches general-purpose reasoning. Real-time human-AI collaboration on complex problems is standard. AI content is the majority of internet content. Critical thinking and human judgement become the most valuable teachable skills."},
    policy:{h:"International AI Education Standards",d:"UNESCO and OECD publish global AI competency frameworks. Cross-border credential recognition simplifies mobility. Mandatory AI impact assessments for publicly funded programmes."},
    labour:{h:"The 30% Threshold",d:"30% of UK economic tasks substantially automated or augmented. FE becomes primary vehicle for adult retraining at scale. Regional disparities create uneven impacts. Colleges in high-automation areas face greatest demand."},
    expectations:{h:"The AI-Native Cohort",d:"Students have never known a world without AI. They expect AI to handle routine tasks, wanting human interaction for mentoring and creativity. AI proficiency is assumed like literacy. The lecturer role has permanently shifted."}}},
  {id:"h1_2030",label:"H1 2030",range:"January to June 2030",conf:"scenario",tracks:{
    technology:{h:"AI-Augmented Workplace is Standard",d:"Working with AI is as normal as email. No meaningful category of 'AI skills' separate from professional competence. AI proficiency embedded in everything."},
    policy:{h:"10 Million Workers Target",d:"Government's 2025 commitment reaches deadline. Uneven results. FE recognised as backbone of national AI infrastructure. Second phase focuses on depth over breadth."},
    labour:{h:"The Human Premium",d:"Clear wage premiums for roles combining AI with human capabilities: negotiation, creativity, ethics, craft, care. Pure knowledge work absorbed by AI. Curricula must focus on human-distinctive capabilities."},
    expectations:{h:"Quality Expectations Transform",d:"Quality judged by AI integration, not absence. AI-free education viewed as outdated. Colleges that embraced transformation earliest are most sought-after."}}},
  {id:"h2_2031",label:"H2 2031",range:"The New Settlement",conf:"scenario",tracks:{
    technology:{h:"Ambient AI & Organisational Agility",d:"AI in physical environments. The AI colleague. The most important capability is organisational agility — how quickly you respond to what arrives tomorrow."},
    policy:{h:"The New Settlement",d:"Comprehensive AI rights and responsibilities framework. FE colleges genuinely valued as primary vehicle for AI-era skills. Policy stability allows long-term planning. A new phase of confidence."},
    labour:{h:"A Transformed Economy",d:"Six years of reshaping. Human skills command highest premiums. Colleges that invested in human capabilities alongside AI produced the most successful graduates."},
    expectations:{h:"Education Reimagined",d:"FE transformed from secondary sector to central pillar of national strategy. Flexibility and vocational focus proved exactly what the AI transition required. The journey was about institutional courage and focus on what students need."}}},
];

const CONF_COLORS={high:C.green,probable:C.amber,scenario:C.purple};
const CONF_LABELS={high:"High Confidence",probable:"Probable Trajectory",scenario:"Scenario-Based"};
...
// ═══════════════════════════════════════════════════════════════════
// PDF GENERATOR (browser-based)
// ═══════════════════════════════════════════════════════════════════
function genReport(name,role,results,responses){
...
function Business({onNav}){
  const[responses,setResponses]=useState({});const[sec,setSec]=useState(0);const[showResults,setShowResults]=useState(false);const[contact,setContact]=useState({name:"",biz:"",email:"",phone:""});const ref=useRef(null);
